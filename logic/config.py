...
config = {
    ...
    "equip": {  # 强化
        ...
        "polish": {  # 炼化
            ...
            "specialtreasure": {  # 专属玉佩
                ...
                "include": [221422, 231857],  # 例外
                "include_general": ["韩信", "项羽", "成吉思汗", "刘邦", "张良", "貂蝉", "周泰", "岳飞"],  # 装备的专属玉佩例外
    ...
    "general": {  # 武将
        ...
        "awaken": {  # 觉醒
            ...
            "general": ["张良", "韩信", "项羽", "成吉思汗", "貂蝉", "赵敏", "戚继光", "孟获"],  # 觉醒将列表
        },
        "tech": {  # 科技
            "enable": True,  # 开启
            "list": ["大将强攻", "大将强防"],  # 允许科技
    ...
    "battle": {  # 征战
        "enable": True,  # 开启
        "armyid": 14919,  # 征战NPC
        "powerid": [170, 300],  # 征战地图从434刀耕火种开始, 492媚娘入宫
        "auto": {  # 过图
            "enable": False,  # 开启
